        ...
        <header className="flex h-14 items-center gap-4 border-b bg-card px-6">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem>
                <a href="/" className="block w-full cursor-pointer">View Site</a>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <form action="/logout" method="POST" className="w-full">
                  <button type="submit" className="w-full text-left cursor-pointer bg-transparent border-none font-inherit">
                    Logout
                  </button>
                </form>
              </DropdownMenuItem>

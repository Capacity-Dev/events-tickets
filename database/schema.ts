...
export class EventSchema extends BaseModel {
  static $columns = ['accessPassword', 'categoryId', 'coverImageUrl', 'createdAt', 'currency', 'description', 'endDate', 'frozenAt', 'galleryImages', 'id', 'isFeatured', 'isFrozen', 'organizerId', 'privatePaymentStatus', 'privateSlug', 'publishedAt', 'seoMeta', 'slug', 'startDate', 'status', 'title', 'updatedAt', 'venueAddress', 'venueCoordinates', 'venueName', 'visibility'] as const
  $columns = EventSchema.$columns
  @column()
  declare accessPassword: string | null
  @column()
  ...
  declare organizerId: number
  @column()
  declare privatePaymentStatus: string | null
  @column()
  declare privateSlug: string | null
  @column.dateTime()
